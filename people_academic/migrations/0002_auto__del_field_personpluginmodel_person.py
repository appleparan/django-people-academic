...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PersonPluginModel.person'
        db.delete_column(u'cmsplugin_personpluginmodel', 'person_id')


    def backwards(self, orm):
        # Adding field 'PersonPluginModel.person'
        db.add_column(u'cmsplugin_personpluginmodel', 'person',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2013, 9, 10, 0, 0), to=orm['people_academic.Person']),
                      keep_default=False)
